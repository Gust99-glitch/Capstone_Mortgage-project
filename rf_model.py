"""
rf_model.py — Random Forest Loan Approval Classifier (24 Features)
===================================================================

Trains a Random Forest model using the combined approved/denied dataset
...
Outputs:
  • models/rf_model.joblib            — saved model
  • models/rf_feature_names.joblib    — feature list used at training
  • models/rf_train_medians.joblib    — training medians for imputation
  • models/rf_feature_importance.png  — top 20 feature importance chart
  • models/rf_metrics.json            — accuracy, ROC-AUC, threshold
"""
...
joblib.dump(feature_names,           f"{OUTPUT_DIR}/rf_feature_names.joblib")
